/**
 * ACT In-Session - Module Configuration
 */

export const modules = [
    { id: 'hexaflex', title: 'Hexaflex', icon: 'navigation', color: '#f59e0b' },
    { id: 'abrirse', title: 'Abrirse', icon: 'lock-open', color: 'var(--hex-abrirse)' },
    { id: 'presente', title: 'Presente', icon: 'wind', color: 'var(--hex-presente)' },
